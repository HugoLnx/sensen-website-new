// Adicionamos uma interface para tipar as props, incluindo a 'size' que não é padrão do SVG
interface IconProps extends React.SVGProps<SVGSVGElement> {
  size?: string | number;
}

// Desestruturamos 'size' e repassamos o restante das props ('...props')
const BlueskyIcon = ({ size, ...props }: IconProps) => (
  <svg
    // Aplicamos 'size' na largura e altura para que o ícone tenha o tamanho correto
    width={size}
    height={size}
    role="img"
    viewBox="0 0 24 24"
