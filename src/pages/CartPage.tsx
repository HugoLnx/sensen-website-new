            ...
            {cart.map((item: typeof cart[number]) => {
              ...
              >
                <div className="flex gap-4">
                  {/* Image */}
                  <div className="w-32 h-32 shrink-0 rounded-lg overflow-hidden bg-slate-800">
                    <ImageWithFallback
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => updateQuantity(gameId, item.quantity - 1)}
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-900 border border-slate-800 rounded-lg p-6 sticky top-24">
              ...
              <div className="space-y-3 mb-6">
                {cart.map((item) => (
                  <div key={getGameId(item)} className="flex justify-between text-sm">
